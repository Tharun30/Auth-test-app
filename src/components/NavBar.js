    ...
    <div className="mcafee-navbar">
      <div className="mcafee-navbar-container">
        ...
        <nav className="mcafee-nav-links">
          {isAuthenticated && (
            <>
              <Link to="/profile" className="mcafee-nav-link">
                <FontAwesomeIcon icon="user" />
                <span>Profile</span>
              </Link>
              <Link to="/external-api" className="mcafee-nav-link">
                <FontAwesomeIcon icon="cloud" />
                <span>External API</span>
              </Link>
              <Link to="/custom-claims" className="mcafee-nav-link">
                <FontAwesomeIcon icon="cogs" />
                <span>Custom Claims</span>
              </Link>
              <Link to="/main-component" className="mcafee-nav-link">
